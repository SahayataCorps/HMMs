...
if __name__=='__main__':
    ...
    if mod == "train":
        ...
        compute_stats=False
    wav_list = os.path.join(data_dir,"lists/wav_{0}.list".format(mod))
    feat_list = os.path.join(data_dir,"lists/feat_{0}.rscp".format(mod))
    ...
    for line in wav_files:
        ...
        feat_rscp_line = "/content/Speech-Recognition-master/Experiments/feat/" + feat_name
